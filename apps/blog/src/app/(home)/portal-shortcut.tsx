...
export function PortalShortcut() {
	...
	return (
		<a
			...
			className='nodesk-portal-shortcut group fixed z-30 flex h-11 max-w-[min(280px,calc(100vw-2rem))] items-center gap-2 rounded-lg border border-white/60 bg-white/45 px-3.5 text-sm font-semibold text-[var(--color-primary)] shadow-[0_14px_38px_rgba(48,40,36,0.16)] backdrop-blur-xl transition duration-200 hover:-translate-y-0.5 hover:bg-white/68 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-brand)]'>
