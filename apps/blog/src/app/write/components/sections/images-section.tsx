				...
				{images.map(item => {
					...
					return (
						<div
							...
							/>
							{isCover && <div className='absolute top-1 left-1 rounded-md bg-blue-500 px-1.5 py-0.5 text-white shadow'>{copy('封面', 'Cover')}</div>}
