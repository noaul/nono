  ...
  try {
    ...
    const stmt = db.prepare(`
      ...
      ON CONFLICT(id) DO UPDATE SET
        ...
        analysis_failed = CASE WHEN excluded.analysis_failed IS NOT NULL THEN excluded.analysis_failed ELSE repositories.analysis_failed END,
        ...
        custom_category = CASE WHEN excluded.custom_category IS NOT NULL THEN excluded.custom_category ELSE repositories.custom_category END,
        category_locked = CASE WHEN excluded.category_locked IS NOT NULL THEN excluded.category_locked ELSE repositories.category_locked END,
        ...
        subscribed_to_releases = CASE WHEN excluded.subscribed_to_releases IS NOT NULL THEN excluded.subscribed_to_releases ELSE repositories.subscribed_to_releases END,
        vector_indexed_at = CASE WHEN excluded.vector_indexed_at IS NOT NULL THEN excluded.vector_indexed_at ELSE repositories.vector_indexed_at END
    `);
    ...
    const upsert = db.transaction(() => {
      ...
      for (const repo of repositories) {
        ...
        stmt.run(
          ...
          repo.analysis_failed === null || repo.analysis_failed === undefined
            ? null
          ...
          repo.category_locked === null || repo.category_locked === undefined
            ? null
            : (repo.category_locked === true || repo.category_locked === 1) ? 1 : 0,
          repo.last_edited ?? null,
          repo.subscribed_to_releases === null || repo.subscribed_to_releases === undefined
            ? null
