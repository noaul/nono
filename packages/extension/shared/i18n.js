...
const zh = {
  ...
  clipPreviewPending: '正在生成正文预览...',
  clipPreviewStats: '{words} 词 · {characters} 字符 · 约 {minutes} 分钟阅读',
...
const en = {
  ...
  clipPreviewPending: 'Preparing article preview...',
  clipPreviewStats: '{words} words · {characters} characters · about {minutes} min read',
